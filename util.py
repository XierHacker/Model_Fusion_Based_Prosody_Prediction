...
#统计结果
def statistic(type="valid"):
    print("CRF")
    prob, labels, preds = extractProb(file="./result/crf/crf_prob_"+type+".txt")
    ...
    print("Alignment")
    prob_align = extractProb2(file="./result/alignment/alignment_prob_"+type+"_epoch5.txt")
    ...
    print("CNN")
    prob_cnn = extractProb2(file="./result/cnn/cnn_prob_"+type+"_epoch5.txt")
    ...
    print("Attention")
    prob_atten = extractProb2(file="./result/attention/attention_prob_"+type+"_epoch4.txt")
    ...
    print("BiLSTM")
    prob_bilstm = extractProb2(file="./result/bilstm/bilstm_prob_"+type+"_epoch3.txt")
    #print("prob_bilstm.shape", prob_bilstm.shape)
    # print("prob_atten:",prob_atten)
    preds_bilstm = np.argmax(prob_bilstm, axis=-1, )
    # print(preds_tten.shape)
    # print(preds_tten)
    p5, f5 = eval(y_true=labels, y_pred=preds_bilstm)
    #print("accuracy:", p5)
    print("f1-score:", f5)
